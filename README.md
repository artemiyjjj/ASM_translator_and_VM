...
| sub | Substraction | значение по адресу / значение | ? | Вычитание значения аргумента из значения аккумулятора с последующей записью результата в аккумулятор |  
| cmp | Compare | значение по адресу / значение | ? | Вычитание значения аргумента из значения аккумулятора без записи результата в аккумулятор |  
...
| asr | Arithmetic bit shift right | - | ? | арифметический сдвиг битов аккумулятора вправо |  
...
Прерывания могут быть вызваны как программным, так и аппаратным способом.
